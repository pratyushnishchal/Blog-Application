				...
				<form action="update-profile" name="update-user-profile"
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="exampleFormControlTextarea1"
							rows="2" placeholder="Bio" name="bio">${loginuser.bio}</textarea>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Country</label> <input type="text" class="form-control"
							placeholder="Enter Country" required="required" name="country" value="${loginuser.country}">
					</div>
					<div class="form-group">
						<label>Userid</label> <input type="text" class="form-control"
							placeholder="Enter Userid" required="required" name="uid" value="${loginuser.uid}">
					</div>
					<div class="form-group">
